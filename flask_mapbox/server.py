...
# route to the new template and send the access key
@app.route('/map')
def mapbox_js():
...
ws_1998_99 = df[df.Semester == 'WS 1998/99']
ws_1999_00 = df[df.Semester == 'WS 1999/00']
ws_2000_01 = df[df.Semester == 'WS 2000/01']
...
m.choropleth(
    ...
    bins=[st_data['Insgesamt, Insgesamt'].min(), 100000, 200000, 300000, 400000, st_data['Insgesamt, Insgesamt'].max()+1],
    highlight=True
)
